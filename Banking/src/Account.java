...
public class Account extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("updatePassword"))
		{
			...
			database.updatePassword(value, id);
		}
		if(action.equals("updatePhone"))
		{	
			String value = request.getParameter("phone");
			database.updatePhone(value, id);
		}
		if(action.equals("withdraw"))
		{
			database.withdraw(id, balance, amount, to, toID, reason);
		}
		if(action.equals("deposit"))
		{
			database.deposit(id, balance, amount, to, toID, reason);
		}
